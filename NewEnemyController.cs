...
public class NewEnemyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Debug.Log("isAttacking: " + isAttacking + ", canTargetTakeDamage: " + canTargetTakeDamage + ", canDealDamage: " + canDealDamage);
        if (canDealDamage)
        {
        ...
        if (!isDead && !isTakingDamage)
        {
            ...
            else
            {
                ...
                if (doesWander)
                {
                    ...
                    Quaternion lookRotation = Quaternion.LookRotation(new Vector3(isNegative * direction.x, 0, isNegative * direction.z));
    ...
    public void TakeDamage(int damageAmount)
    {
        ...
        else 
        {
            ...
            Debug.Log("will stagger: " + (x == staggerChance));
    ...
    private void OnTriggerEnter(Collider collider)
    {
        if (collider.gameObject.CompareTag("Player"))
        {
            ...
            // if player is in the enemy hitbox, they have a chance to take damage
    ...
    IEnumerator WaitToAttack()
    {
        ...
        //Debug.Log("going to wait " + n + " seconds");
        yield return new WaitForSeconds(n);
        //Debug.Log("done waiting to attack");
